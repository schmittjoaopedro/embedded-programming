...
void loop() {
  ...
  while(executable > 0) {
    ...
    execute(   80, 100, 157, 50, 110, 100, 60, 80, 70, 90,
               80, 100, 120, 70, 110, 90, 160, 10, 70 , 100 );    
       
               delay(logTime);        
               
    execute(   80, 100, 120, 70, 110, 90, 160, 10, 70 , 100,
               80, 140, 157, 70, 100, 90, 110, 15, 60, 100);  

               delay(logTime);        
               
    execute(   80, 140, 157, 70, 100, 90, 110, 15, 60, 100,
               100, 140, 157, 70, 100, 100, 110, 15, 60, 100);
