...
void loop() {
  ...
  while(executable > 0) {
    ...
    execute(   100, 95, 100, 95, 103, 95, 80, 85, 90, 100,
               100, 75, 100, 75, 103, 95, 60, 85, 70, 100 );
             
               delay(logTime);
               
    execute(   100, 75, 100, 75, 103, 95, 60, 85, 70, 100,
               80, 95, 100, 75, 95, 95, 60, 85, 70, 75 );
               
               delay(logTime);
               
    execute(   80, 95, 100, 75, 95, 95, 60, 85, 70, 75,
               80, 95, 100, 95, 110, 95, 80, 85, 90, 90 );
                              
               delay(logTime);
              
    execute(   80, 95, 100, 95, 110, 95, 80, 85, 90, 90,
