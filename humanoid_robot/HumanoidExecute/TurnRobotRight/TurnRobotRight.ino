...
void loop() {
  ...
  while(executable > 0) {
    ...
    execute(   100, 95, 100, 95, 103, 95, 80, 85, 90, 100,
               100, 115, 100, 115, 103, 95, 100, 85, 110, 100 );
             
               delay(logTime);
             
    execute(   100, 115, 100, 115, 103, 100, 100, 85, 110, 100,
               120, 115, 100, 115, 103, 100, 100, 85, 90, 120 );
               
               delay(logTime);
               
    execute(   120, 115, 100, 115, 103, 100, 100, 85, 90, 120,
               110, 95, 100, 95, 103, 90, 80, 85, 90, 125 );
               
               delay(logTime);
               
    execute(   110, 95, 100, 95, 103, 90, 80, 85, 90, 125,
